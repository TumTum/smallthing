...
--
-- Host: localhost
-- Erstellungszeit: 31. Jan 2017 um 00:37
...
INSERT INTO `Adresse` (`Adress_ID`, `Adresse`, `Hausnummer`, `PLZ`, `Ort`) VALUES
(0, 'hallostraÃŸe', 15, 904444, 'gunzenhausen'),
(1, 'Drausnickstr.', 45, 91058, 'Erlangen');
...
('test@example.com', '6ZaxN2Vzm9NUJT2y', NULL, NULL, 1, '', 'test_user');
...
CREATE TABLE IF NOT EXISTS `Inhalt-Menue` (
  `Inhalt-Menue_ID` int(11) NOT NULL,
...
INSERT INTO `Inhalt-Menue` (`Inhalt-Menue_ID`, `Menue_ID`, `Produkt_ID`) VALUES
(1, 1, 16),
(2, 1, 17),
(3, 1, 8),
(4, 2, 9),
...
CREATE TABLE IF NOT EXISTS `Inhalt-Produkt` (
  `Inhalt-Produkt_ID` int(11) NOT NULL,
...
INSERT INTO `Inhalt-Produkt` (`Inhalt-Produkt_ID`, `Zutat ID`, `Produkt-ID`, `Einheit`, `Menge`) VALUES
(0, 0, 0, '', 0),
(1, 12, 6, 'Gramm', 100),
(2, 1, 7, 'Stück', 1),
(3, 2, 7, 'Stück', 2),
...
ALTER TABLE `Inhalt-Menue`
 ADD PRIMARY KEY (`Inhalt-Menue_ID`);

--
-- Indizes für die Tabelle `Inhalt-Produkt`
--
ALTER TABLE `Inhalt-Produkt`
 ADD PRIMARY KEY (`Inhalt-Produkt_ID`);
